...
<form action='student.php#student_information' method='post' id='student_information'>
    ...
    if ($program_id != 0)
    {
        ?>
        <p>
            <input type="button" value="Download Student Plan" onclick="window.location.href='student-print.php?cwu_id=<?php echo $cwu_id; ?>&program_id=<?php echo $program_id; ?>&pdf=1';">
        </p>
